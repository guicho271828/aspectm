...
AspectM provides CLOS-like /around/ hooks for
macroexpansion. /around/ hooks are nested, just like nesting
...
Upon this layered /around/ hooks system, AspectM implements a set of hooks
...
prepends/appends forms to the main form returned by the macro.
Thus, they are not able to modify the main
expansion result.
